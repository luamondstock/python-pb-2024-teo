...
def escolhe_opcao():
    ...
    def cadastra_livro():
        ...
        livro_genero = input(f'Digite o gênero de {nome_livro} que irá cadastrar: ')
    ...
    def listar_livro():
        ...
        print(f'{"Nome do livro".ljust(22)} | {"Gênero".ljust(20)} | {"Status"}')
        for livro in livros:
    ...
    def ativar_leitura():
        ...
        nome_livro = input('Digite o nome do livro para ativar/desativar: ')
        ...
        for livro in livros:
            if nome_livro == livro['nome']:
                ...
                mensagem = f'O cadastro de {nome_livro} foi ativado com sucesso' if livro['ativo'] else f'O cadastro de {nome_livro} foi desativado'
                print(mensagem)
    ...
    def opcao_invalida():
        print('Opa, esta opção não é permitida\n')
        retorna_menu()
